...
MEM_INACTIVE=$(memory_pressure | grep "Pages inactive" | grep -o -E '[0-9]+')
MEM_FREE=$(memory_pressure | grep "Pages free" | grep -o -E '[0-9]+' | awk -v MEM_INACTIVE=$MEM_INACTIVE '{ print $1 + MEM_INACTIVE }')
